<template>
  <header>
    <nav class="header">
      <a href="#" class="nav-item"><img src="../assets/bslogo.png" class="logo"></a>
      <div>
  ...
  <body>
    ...
    <main2 name="landing2">
      <div class="main-container2" style="float: left; width: 50%; heignt:10%;">
        <div class="head2" >
          <div style="text-align:left;">바로우산?</div> 
          <tr>
            <td>
              <div class="sub-head2" @click="scrollImg()" @change="changImg()" style="font-size: 1.5vw; color:green;">{{ai}}</div>
            </td>
            <td>
              <div class="head-l" style="font-size: 1.5vw;">을 이용한 공유경제 자동화 서비스</div>
            </td>
          </tr>
        </div>
      </div>
      <div style="float: left; width: 50%; heignt:10%;">
        <img :src="imgNum" style="width:100%; heigh:100%;">
      </div>
    </main2>
    <main class="text-left" name="landing3">
      <tr>
        <div style="font-size:3vw;">ChatGPT를 사용한 사용 안내</div>
        <div><img src="../assets/chatimg.png"></div>
      </tr>
    ...
    <main2>
      ...
      <div id="app" style="float: left; width: 33%;">
        <div class="card-row">
          <div class="card">
            <img class="card-image" src="../assets/devgs.png">
            <div class="card-footer">
              <p class="card-text" style="font-size:20px; font-weight:bold; text-align:left;">이강산</p>
              <a href="https://github.com/gangsanlee2" class="footer-items" style="color:black;"><img src="https://play-lh.googleusercontent.com/PCpXdqvUWfCW1mXhH1Y_98yBpgsWxuTSTofy3NGMo9yBTATDyzVkqU580bfSln50bFU" alt="" class="icon" style="float: left;"></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer name="landing4" style="width:100%;"> 
    <div class="footer-container">
      <div class="footer-menu">
        <div class="first-box">
          <img src="../assets/footerlogo.png" class="logo">
          <div class="column">
...
export default {
  ...
  methods : {
    ...
    scrollImg(){
      if (this.ai == 'ChatGPT'){
        this.ai = '객체 인식';
      }else if (this.ai == '객체 인식'){
        this.ai= '수요 예측'
      }else if (this.ai == '수요 예측'){
        this.ai='ChatGPT'
      }
    },
    changImg(){
      if (this.ai == 'ChatGPT'){
        this.imgNum = '../assets/chatimg.png'
      }else if (this.ai == '객체 인식'){
        this.imgNum= '../assets/detect.png'
      }else{
        this.imgNum='../assets/bslogo.png'
      }
    }
  },
  components: {
...
.main-container-img{
  background-image: url('../assets/detectimg.png');
  width: 100%;
  height: 50%;
  background-size: 100%;
}
